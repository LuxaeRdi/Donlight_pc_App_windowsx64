...
Grid{
    ...
    columns:6
            ...
            DropModule{
                ...
                patternName: "patternsDAF_abw.bin"
            ...
            DropModule{
                ...
                patternName: "patternsDAF_bw.bin"
            ...
            DropModule{
                ...
                width:parent.width/parent.columns
                number: 8
                configName: "BLstraightDaftruck.bin"
                patternName: "patternsDAF_w.bin"
                appName: "v057rev2.bin"
                hwName:"57 rev2"
            }
            ...
            DropModule{
                ...
                width:parent.width/parent.columns
                number: 7
                configName: "BRstraightDaftruck.bin"
                patternName: "patternsDAF_w.bin"
                appName: "v057rev2.bin"
                hwName:"57 rev2"
            }
